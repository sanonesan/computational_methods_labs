...
*/
template<typename T, typename F>
void ode_RK4_fix_step(T start_time, T end_time, T tau, vector<T> x, const vector<F> &func, const string &out_path){
...
*/
template<typename T, typename F>
void ode_RK4_vary_step(T start_time, T end_time, T tau, vector<T> x, const vector<F> &func, const T tol, const string &out_path){
