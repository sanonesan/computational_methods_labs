...
class Class_Fred{
    ...
    public:
        ...
        */
        ...
        Class_Fred<T> DEFAULT_TEST_singular(){
            ...
            auto Q = [](std::pair<T, T> k_i, std::pair<T, T> c_i) -> std::pair<T, T> {
                ...
                tmp.first = (- (k_i.second - c_i.second)) / 2 / M_PI 
                            / (pow((k_i.first - c_i.first), 2) + pow((k_i.second - c_i.second), 2));

                tmp.second = (k_i.first - c_i.first) / 2 / M_PI 
                            / (pow((k_i.first - c_i.first), 2) + pow((k_i.second - c_i.second), 2));
